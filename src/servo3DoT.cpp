...
/*
  ...
  The methods are:
   Servo3DoT - Class for manipulating servo motors connected to Arduino pins.
...
uint8_t Servo3DoT::attach(int pin)
{
  return this->attach(pin, MIN_PULSE_WIDTH, MAX_PULSE_WIDTH);
}

uint8_t Servo3DoT::attach(int pin, int min, int max)
{
...
void Servo3DoT::write(int value)
{
...
void Servo3DoT::writeMicroseconds(int value)
{
...
*/
void Servo3DoT::write(int value, uint8_t speed) {
...
void Servo3DoT::write(int value, uint8_t speed, bool wait) {
  write(value, speed);
...
int Servo3DoT::readMicroseconds()
{
...
bool Servo3DoT::attached()
{
  return servos[this->servoIndex].Pin.isActive ;
}

uint8_t Servo3DoT::sequencePlay(servoSequencePoint sequenceIn[], uint8_t numPositions, bool loop, uint8_t startPos) {
...
uint8_t Servo3DoT::sequencePlay(servoSequencePoint sequenceIn[], uint8_t numPositions) {
  return sequencePlay(sequenceIn, numPositions, true, 0);
}

void Servo3DoT::sequenceStop() {
  write(read());
  this->curSeqPosition = CURRENT_SEQUENCE_STOP;
}
...
/*
	To do
int Servo3DoT::targetPosition() {
	byte channel = this->servoIndex;
	return map( servos[channel].target+1, SERVO_MIN(), SERVO_MAX(), 0, 180);
}
int Servo3DoT::targetPositionMicroseconds() {
	byte channel = this->servoIndex;
